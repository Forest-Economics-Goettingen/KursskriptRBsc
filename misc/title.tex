...
\begin{flushleft}
\includegraphics[height=3cm]{misc/fig/logo_wildtierwissenschaften.png}
~\\[0.4cm]
...
\vfill
%\includegraphics[width=10cm,height=4cm]{misc/fig/logo-uni-neu.png}
\includegraphics[width=14cm]{misc/fig/logo-uni-neu.png}
~\\[0.4cm]
