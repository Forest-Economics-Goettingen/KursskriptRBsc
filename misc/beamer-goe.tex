...
% Title graphic
 \titlegraphic{\includegraphics[height=1.1cm]{./misc/fig/logo_wildtierw.png}\hspace{15px}\includegraphics[height=1cm]{./misc/fig/logo_felap}\hspace{20px}\includegraphics[height=1cm]{./misc/fig/logo_gau}}
