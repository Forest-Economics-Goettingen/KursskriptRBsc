...
Ein Data-Science-Projekt umfasst in der Regel sech Schritte: Import, Tidy, Transform, Visualize, Model und Communicate (vgl. Wickham et al., R for Data Science 2e; https://r4ds.hadley.nz/) aus 4 Stufen. Wir werden diese Schritte alle ansprechen, jedoch in unterschiedlicher Tiefe. 

```{r fig-workflow, echo=FALSE, fig.cap="Data-Science-Workflow nach Wickham et al. (R4DS 2e)", out.width="80%"}
knitr::include_graphics("img/data_science_steps.png")
```
...
- Kapitel 2: Verstehen des Unterschieds zwischen R und RStudio, erstellen eines Projektes und Skripten, installieren und laden von Paeketen. 

# R und RStudio

## Installation von R und RStudio

Installieren Sie zunächst R und anschließend RStudio Desktop. R ist die Programmiersprache, RStudio die integrierte Entwicklungsumgebung (IDE), die das Arbeiten mit R deutlich erleichtert.^[IDE = Integrated Development Environment.]
...
```{r, echo = FALSE, fig.align="center", fig.cap= "(ref:rproj3)"}
