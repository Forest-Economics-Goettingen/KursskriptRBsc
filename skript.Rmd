...
Funktionen diese Form der Datenoganisation erwarten. Somit müssen sie Ihre Daten nur ein Mal
...
Diese Daten sind jetzt im `wide`-Format gespeichert und nicht *tidy*, weil Information über die Daten (nämlich das Jahr der Aufnahme in den Spaltennamen gespeichert sind).
